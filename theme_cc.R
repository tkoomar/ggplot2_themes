...
theme_cc <- function (base_size = 25, 
  ...
  theme(
    ...
    legend.margin = margin(half_line/10, half_line/10, half_line/10, half_line/10),
    ...
    panel.grid.minor = element_line(size = rel(1/4), linetype = 3), 
    ...
    strip.text = element_text(
      ...
      size = rel(1), 
      margin = margin(half_line/10, half_line/10, half_line/10, half_line/10)
      ),
    strip.text.x = NULL, 
