...
#### axis ####
    ...
    axis.text.x = element_text(
      margin = margin(t = 0.5 * half_line/4), 
      vjust = 1), 
    axis.text.x.top = element_text(
      margin = margin(b = 0.5 * half_line/4), 
      vjust = 0), 
    axis.text.y = element_text(
      margin = margin(r = 0.5 * half_line/4), 
      hjust = 1), 
    axis.text.y.right = element_text(margin = margin(l = 0.5 * half_line/2), 
                                     hjust = 0), 
    axis.ticks = element_line(colour = "white", size = base_line_size/4),
    axis.ticks.length = unit(base_size/6, "pt"), 
...
#### strip ####
    ...
    strip.text = element_text(
      colour = "white",
      size = rel(0.8), 
      margin = margin(0.2 * half_line, 0.2 * half_line, 0.2 * half_line, 0.2 * half_line)
      ),
    strip.text.x = NULL, 
...
#### panel ####
  ...
  panel.grid.minor = element_line(colour = "grey50", size = rel(1), linetype = 2), 
...
#### plot ####    
    ...
    plot.margin = margin(0.5 * half_line, 0.5 * half_line, 0.5 * half_line, 0.5 * half_line), 
    complete = TRUE)
}
