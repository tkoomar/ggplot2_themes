## A dark theme, based on the text editor pallete
require(ggplot2)
require(showtext) ## for google fonts
font_add_google("Share Tech Mono")
showtext_auto()

colors_merb_seq <- c("#FF0000", "#FF8400", "#3EBF36", "#1299DA", "#BB22DD")

colors_merb <- c("#BB22DD", "#FF8400", "#3EBF36", "#1299DA", "#FF0000" )

theme_merb <- function (base_size = 12, 
                       base_family = "Share Tech Mono", 
...
#### panel ####
  panel.background = element_rect(fill = "#222220", colour = NA), 
